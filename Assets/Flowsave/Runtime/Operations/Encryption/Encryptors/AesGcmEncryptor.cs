...
namespace Flowsave.Operations
{
    public sealed class AesGcmEncryptor : IEncryptor
    {
        ...
        public EncryptionType Alg => _key.Length == 32 ? EncryptionType.Aes256Gcm : EncryptionType.Aes128Gcm;
        ...
        public AesGcmEncryptor(AesOptions options) : this(options.Key, options.Nonce) { }
